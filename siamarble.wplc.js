...
// @updateURL    https://raw.githubusercontent.com/Jahykun/SiaMarble/refs/heads/main/siamarble.wplc.js
// @downloadURL  https://raw.githubusercontent.com/Jahykun/SiaMarble/refs/heads/main/siamarble.wplc.js
...
(() => {
  ...
  async function blendTileWithTemplate(blob, tileX, tileY, contentType){
    ...
    const dotSize = dotMode ? Math.max(1, scale * (clearDots ? 0.85 : 0.65)) : 1;
    const dotOffset = dotMode ? (scale - dotSize) / 2 : 0;
    const outlineSize = clearDots ? Math.min(scale, dotSize + 1) : 0;
    const outlineOffset = clearDots ? (scale - outlineSize) / 2 : 0;
